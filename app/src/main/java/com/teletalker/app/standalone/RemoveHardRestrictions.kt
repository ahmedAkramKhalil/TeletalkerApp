...
package com.teletalker.app.standalone
...
private fun mainInternal() {
    ...
    val changed = removeRestriction("com.teletalker.app", Manifest.permission.READ_CALL_LOG, 0)
    val suffix = "from ${"com.teletalker.app"} for ${Manifest.permission.READ_CALL_LOG}"
